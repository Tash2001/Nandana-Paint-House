...
const {
  ...
  updateBrands,
  deleteBrand,
} = require("../controllers/Inventory Controllers/BrandsController");
const {
  addCategories,
  getCategory,
  updateCategory,
  deleteCategory,
} = require("../controllers/Inventory Controllers/CategoriesController");
const {
  addSCategories,
  getSCategory,
  updateSCategory,
  deleteSCategory,
} = require("../controllers/Inventory Controllers/SubCategoryController");
const {
  createColor,
  getColors,
  updateColor,
  deleteColor,
} = require("../controllers/Inventory Controllers/ColorController");
const {
  addUnit,
  getUnits,
  updateUnit,
  deleteUnit,
} = require("../controllers/Inventory Controllers/UnitsController");
const {
  addProduct,
  getProducts,
  getProductById,
  updateProduct,
  deleteProduct,
} = require("../controllers/Inventory Controllers/ProductsController");
const {
  addStock,
  getStock,
  getStockByProduct,
  updateStock,
  deleteStock,
} = require("../controllers/Inventory Controllers/StockController");
const {
  buyProduct,
  sellProduct,
  getTransactions,
  getTransactionsByProduct,
} = require("../controllers/Inventory Controllers/TransactionController");
